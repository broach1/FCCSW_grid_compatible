...
geoservice = GeoSvc("GeoSvc", detectors=['file:DetectorDescription/Detectors/compact/FCChh_DectMaster.xml','file:DetectorDescription/Detectors/compact/FCChh_ECalBarrel_Mockup.xml'],
                    OutputLevel = DEBUG)
...
savecaltool = G4SaveCalHits("saveCalHits")
savecaltool.DataOutputs.caloClusters.Path = "clusters"
savecaltool.DataOutputs.caloHits.Path = "hits"
